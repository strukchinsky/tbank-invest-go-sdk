...
func (c *ordersStreamServiceClient) TradesStream(ctx context.Context, in *TradesStreamRequest, opts ...grpc.CallOption) (OrdersStreamService_TradesStreamClient, error) {
	...
	x := &ordersStreamServiceTradesStreamClient{ClientStream: stream}
...
func (c *ordersStreamServiceClient) OrderStateStream(ctx context.Context, in *OrderStateStreamRequest, opts ...grpc.CallOption) (OrdersStreamService_OrderStateStreamClient, error) {
	...
	x := &ordersStreamServiceOrderStateStreamClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _OrdersStreamService_TradesStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(OrdersStreamServiceServer).TradesStream(m, &ordersStreamServiceTradesStreamServer{ServerStream: stream})
}
...
func _OrdersStreamService_OrderStateStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(OrdersStreamServiceServer).OrderStateStream(m, &ordersStreamServiceOrderStateStreamServer{ServerStream: stream})
}
